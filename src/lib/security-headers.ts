...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "img-src 'self' data: https://www.google-analytics.com https://www.googletagmanager.com https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.ggpht.com",
